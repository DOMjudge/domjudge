...
archive has to adhere to the `problemarchive.org format`_ (DOMjudge always adheres to the `CLICS`_ subset both are not always in sync).
...
.. _CLICS: https://clics.ecs.baylor.edu/index.php?title=Problem_format
