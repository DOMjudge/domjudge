...
ID used for the team and the category ID field is the values as provided during the import of
...
used for the user and the ``team_id`` field is the values as provided during the team import.
