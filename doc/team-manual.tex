...
\title{Teammanual \DOMjudge\\(version \DOMJUDGE_VERSION)}
...
automatically be notified by a popup window. For this to work, you
have to have the teampage opened in a webbrowser and the browser must
not block popup windows.
