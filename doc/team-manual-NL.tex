...
\textbf{websubmit} en daar kun je een file selecteren en insturen.
...
Het submit programma maakt gebruik van een directory \cmd{\USERSUBMITDIR}
...
door naar \textbf{websubmit} te gaan. Daar kan een bestand
geselecteerd worden om in te sturen. Verder kan het probleem en de
taal van de inzending ingesteld worden. Deze kunnen ook op het
standaard geselecteerde `automatisch' laten staan worden; dan wordt
...
Nadat je op de submit knop geklikt hebt en dit bevestigd hebt, wordt
geconfirmeerd of je inzending aangekomen is. Daarna zou deze in je
lijst met inzendingen moeten staan.
...
teampagina is \url{\WEBBASEURI team}. Hiervandaan kun je ook naar
