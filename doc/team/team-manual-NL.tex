...
De uitvoer van je programma verschilde slechts in presentatie met de
correcte uitvoer. Dit wordt net als WRONG-ANSWER niet correct
gerekend. Deze uitslag is optioneel en mogelijk niet aangezet.
...
De code hoort bij de volgende probleembeschrijving: op de eerste regel
van de invoer staat een getal: het aantal testgevallen. Daarna voor
ieder testgeval \'e\'en regel met daarop een naam (\'e\'en woord) van
ten hoogste 99 karakters. Voer voor ieder testgeval op een losse regel
de string ``Hello $<$naam$>$!'' uit.
