...
\renewcommand{\lastmodified}{Laast gewijzigd}
...
\hypersetup{
	...
	pdfauthor={DOMjudge Developers <domjudge-devel@lists.a-eskwadraat.nl>},
	...
	pdfkeywords={DOMjudge,manual,team,handleiding,dom,judge,jury,programmeren,wedstrijd,programmeerwedstrijd,icpc,acm}
}
