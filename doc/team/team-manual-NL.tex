...
past. Gebruik \cmd{submit --help | more} om alles te lezen.
...
configuratie van het systeem, kun je de inzendingsdetails voor de
precieze foutmelding inzien. Compiler\emph{waarschuwingen} worden
niet als fouten gezien, maar kun je ook bekijken bij de details van je
inzending (afhankelijk van de systeemconfiguratie).
