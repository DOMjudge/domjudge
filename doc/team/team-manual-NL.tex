...
\item[COMPILER-ERROR]
Het compileren van je programma gaf een fout. Op de inzendingsdetails
pagina kun je de precieze foutmelding inzien (deze optie kan uitgezet
zijn).
...
\subsection{Java klasse naamgeving}
