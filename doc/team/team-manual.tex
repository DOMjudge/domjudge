...
With
\ifcmdsubmit{the \cmd{submit} program}
\ifcmdsubmit{\ifwebsubmit{or}}
\ifwebsubmit{the web interface}
(see section~\ref{submit}) you can submit a solution to a problem to
the jury. Note that you have to submit the source code of your program
