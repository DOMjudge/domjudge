...
On your desktop is a folder \cmd{NWERC Docs}, which contains the C(++) and
Java documentation.

Command-line submission can be done by using \cmd{submit.exe} from either a
...
\cmd{sampledata} containing the sample input/output data metioned in the
problem set.
...
Do not declare any of your classes as \cmd{public}.
