...
\item[Web interface]
From your team page, \url{\WEBBASEURI team}, click Browse in the
...
In the left column click Browse to select the file for submission.
\textsc{dom}judge will try to determine the problem and
