...
\item[Web interface]
From your team page, \url{\WEBBASEURI team}, click {\em Select file\ldots} in the
...
from the extension. Click {\em Add another file} to add more files to the
submission.
\end{description}
...
In the left column click {\em Select file\ldots} to select the file for submission.
...
When you've selected the first source file, you may use the {\em Add more
