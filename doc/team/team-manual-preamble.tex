...
% Only show text if configured with a feature
\newcommand{\ifthen}[2]{\ifthenelse{\equal{#1}{1}}{#2}{}}
\newcommand{\ifcmdsubmit}[1]{\ifthen{\ENABLECMDSUBMITSERVER}{#1}}
\newcommand{\ifwebsubmit}[1]{\ifthen{\ENABLEWEBSUBMITSERVER}{#1}}
