...
class ClarificationControllerTest extends BaseTest
{
    ...
    public function testAnonymousOnlyGeneral()
    {
        ...
        $this->assertEquals("-34069:06:40.000", $clarificationFromApi[0]['contest_time']);
