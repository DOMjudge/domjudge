...
final class Version20260106214943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contest ADD external_source_enabled TINYINT(1) DEFAULT 0 NOT NULL COMMENT \'Is shadow mode enabled for this contest?\', ADD external_source_type VARCHAR(255) DEFAULT NULL COMMENT \'Type of the external source\', ADD external_source_source VARCHAR(255) DEFAULT NULL COMMENT \'Source for external contest data\', ADD external_source_username VARCHAR(255) DEFAULT NULL COMMENT \'Username for external source, if any\', ADD external_source_password VARCHAR(255) DEFAULT NULL COMMENT \'Password for external source, if any\', ADD external_source_last_event_id VARCHAR(255) DEFAULT NULL COMMENT \'Last encountered event ID from external source, if any\', ADD external_source_last_poll_time NUMERIC(32, 9) UNSIGNED DEFAULT NULL COMMENT \'Time of last poll by event feed reader\', ADD external_source_last_httpcode SMALLINT UNSIGNED DEFAULT NULL COMMENT \'Last HTTP code received by event feed reader\'');
        ...
        $this->addSql('UPDATE contest c
            ...
            SET c.external_source_enabled = 1,
                ...
                c.external_source_last_httpcode = ecs.last_httpcode');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE external_contest_source (extsourceid INT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT \'External contest source ID\', cid INT UNSIGNED DEFAULT NULL COMMENT \'Contest ID\', type VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Type of this contest source\', source VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Source for this contest\', username VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Username for this source, if any\', password VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Password for this source, if any\', last_event_id VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Last encountered event ID, if any\', last_poll_time NUMERIC(32, 9) UNSIGNED DEFAULT NULL COMMENT \'Time of last poll by event feed reader\', last_httpcode SMALLINT UNSIGNED DEFAULT NULL COMMENT \'Last HTTP code received by event feed reader\', UNIQUE INDEX cid (cid), PRIMARY KEY (extsourceid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'Sources for external contests\'');
        ...
        $this->addSql('INSERT INTO external_contest_source (cid, type, source, username, password, last_event_id, last_poll_time, last_httpcode)
            SELECT cid, external_source_type, external_source_source, external_source_username, external_source_password, external_source_last_event_id, external_source_last_poll_time, external_source_last_httpcode
            FROM contest WHERE external_source_enabled = 1');

        // Remove columns from contest
        $this->addSql('ALTER TABLE contest DROP external_source_enabled, DROP external_source_type, DROP external_source_source, DROP external_source_username, DROP external_source_password, DROP external_source_last_event_id, DROP external_source_last_poll_time, DROP external_source_last_httpcode');
