...
/**
 * @extends AbstractRestController<JudgingRun|ExternalRun, JudgingRunWrapper>
 */
...
class RunController extends AbstractRestController implements QueryObjectTransformer
{
    ...
    {
        /** @var JudgingRun|ExternalRun $judgingRun */
        $judgingRun = $object;
        if ($judgingRun instanceof ExternalRun) {
            $judgementTypeId = $this->verdicts[$judgingRun->getResult()] ?? null;
        } else {
