...
var bbold_js_1 = require("./chtml/bbold.js");
var upsmall_js_1 = require("./chtml/upsmall.js");
var uplarge_js_1 = require("./chtml/uplarge.js");
...
var Base = (0, common_js_1.CommonMathJaxNewcmFontMixin)(FontData_js_1.ChtmlFontData);
var MathJaxNewcmFont = (function (_super) {
    __extends(MathJaxNewcmFont, _super);
    function MathJaxNewcmFont() {
        var _this = _super.apply(this, __spreadArray([], __read(arguments), false)) || this;
        _this.cssFontPrefix = 'NCM';
        return _this;
    }
    MathJaxNewcmFont.NAME = 'MathJaxNewcm';
    MathJaxNewcmFont.OPTIONS = __assign(__assign({}, Base.OPTIONS), { fontURL: '@mathjax/mathjax-newcm-font/js/chtml/woff2', dynamicPrefix: '@mathjax/mathjax-newcm-font/js/chtml/dynamic' });
    ...
    MathJaxNewcmFont.defaultStyles = __assign(__assign({}, FontData_js_1.ChtmlFontData.defaultStyles), { 'mjx-container[jax="CHTML"] > mjx-math.NCM-N[breakable] > *': {
    ...
    MathJaxNewcmFont.defaultFonts = __assign(__assign({}, FontData_js_1.ChtmlFontData.defaultFonts), { '@font-face /* MJX-NCM-ZERO */': {
    ...
    MathJaxNewcmFont.dynamicFiles = FontData_js_1.ChtmlFontData.defineDynamicFiles([
        ['latin', {
                'normal': [
