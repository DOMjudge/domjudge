...
INSERT INTO `contest` (`cid`, `name`, `shortname`, `externalid`, `activatetime`, `starttime`, `freezetime`, `endtime`, `unfreezetime`, `deactivatetime`, `activatetime_string`, `starttime_string`, `freezetime_string`, `endtime_string`, `unfreezetime_string`, `deactivatetime_string`, `enabled`, `process_balloons`, `public`) VALUES
(1, 'Demo practice session', 'demoprac', 'demoprac', UNIX_TIMESTAMP(CONCAT(YEAR(NOW()), '-01-01 08:00:00')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW()),'-01-01 09:00:00')), NULL, UNIX_TIMESTAMP(CONCAT(YEAR(NOW()),'-01-01 11:00:00')), NULL, UNIX_TIMESTAMP(CONCAT(YEAR(NOW()),'-01-01 15:00:00')), '-1:00', CONCAT(YEAR(NOW()),'-01-01 09:00:00 Europe/Amsterdam'), NULL, '+2:00', NULL, '+6:00', 1, 1, 0),
(2, 'Demo contest', 'demo', 'demo', UNIX_TIMESTAMP(CONCAT(YEAR(NOW()),'-01-01 10:29:59.877')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW()),'-01-01 11:00:00')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW())+2,'-01-01 15:00:00')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW())+2,'-01-01 16:00:00')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW())+2,'-01-01 16:30:00')), UNIX_TIMESTAMP(CONCAT(YEAR(NOW())+2,'-01-01 17:30:00')), '-00:30:00.123', CONCAT(YEAR(NOW()),'-01-01 12:00:00 Europe/Amsterdam'), CONCAT(YEAR(NOW())+2,'-01-01 16:00:00 Europe/Amsterdam'), CONCAT(YEAR(NOW())+2,'-01-01 17:00:00 Europe/Amsterdam'), CONCAT(YEAR(NOW())+2,'-01-01 17:30:00 Europe/Amsterdam'), CONCAT(YEAR(NOW())+2,'-01-01 18:30:00 Europe/Amsterdam'), 1, 1, 1);
