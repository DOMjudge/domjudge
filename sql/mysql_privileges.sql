...
GRANT SELECT (probid, name, cid, allow_submit, allow_judge, color)    ON problem    TO `domjudge_public`, `domjudge_plugin`;
...
GRANT SELECT (probid, name, cid, allow_submit, allow_judge, color)    ON problem    TO `domjudge_team`;
