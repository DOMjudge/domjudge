...
('script_timelimit', '60', 'int', '0', 'Judging', 'Maximum seconds available for compile/compare scripts. This is a safeguard against malicious code and buggy scripts, so a reasonable but large amount should do.'),
...
('script_filesize_limit', '2197152', 'int', '0', 'Judging', 'Maximum filesize (in kB) compile/compare scripts may write. Submission will fail with compiler-error when trying to write more, so this should be greater than any *intermediate or final* result written by compilers.'),
('timelimit_overshoot', '"2s|20%"', 'string', '0', 'Judging', 'Time that submissions are kept running beyond timelimt before being killed. Specify as "Xs" for X seconds, "Y%" as percentage, or a combination of both separated by one of "+|&" for the sum, maximum, or minimum of both.'),
...
('lazy_eval_results', '0', 'bool', '0', 'Judging', 'Lazy evaluation of results? If enabled, stops judging as soon as a highest priority result is found, otherwise always all testcases will be judged.'),
...
('update_judging_seconds', '5', 'int', '0', 'Judging', 'Post updates to a judging every X seconds. Set to 0 to update after each judging_run.'),
...
('clar_queues', '{"jury":"Jury","domjudge":"DOMjudge","misc":"General Issues"}', 'array_keyval', '1', 'Clarification', 'List of clarification queues'),
...
('thumbnail_size', '200', 'int', '0', 'Display', 'Maximum width/height of a thumbnail for uploaded testcase images.'),
('show_limits_on_team_page', '1', 'bool', '1', 'Display', 'Show time and memory limit on the team problems page'),
...
('data_source', '2', 'int', '0', 'Misc', 'Source of data. Choices: 0 = all local, 1 = configuration data external, 2 = configuration and live data external');
...
('kt', 'kotlin', 'Kotlin', '["kt"]', 1, "Main class", 1, 1, 1, 'kt'),
...
('py2', 'python2', 'Python 2', '["py2","py"]', 1, "Main file", 1, 1, 1, 'py2'),
('py3', 'python3', 'Python 3', '["py3"]', 1, "Main file", 1, 1, 1, 'py3'),
