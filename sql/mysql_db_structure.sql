...
CREATE TABLE `contest` (
  ...
  `activatetime_string` varchar(30) NOT NULL COMMENT 'Authoritative absolute or relative string representation of activatetime',
  `starttime_string` varchar(30) NOT NULL COMMENT 'Authoritative absolute (only!) string representation of starttime',
  `freezetime_string` varchar(30) DEFAULT NULL COMMENT 'Authoritative absolute or relative string representation of freezetime',
  `endtime_string` varchar(30) NOT NULL COMMENT 'Authoritative absolute or relative string representation of endtime',
  `unfreezetime_string` varchar(30) DEFAULT NULL COMMENT 'Authoritative absolute or relative string representation of unfreezetrime',
  `deactivatetime_string` varchar(30) DEFAULT NULL COMMENT 'Authoritative absolute or relative string representation of deactivatetime',
