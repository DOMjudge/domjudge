...
<?php	if ( $cnew ) { ?>
<a class="new" href="clarifications.php" accesskey="c" id="clarifications">clarifications (<?=$cnew?> new)</a>
<?php	} else { ?>
<a href="clarifications.php" accesskey="c" id="clarifications">clarifications</a>
<?php	} ?>
